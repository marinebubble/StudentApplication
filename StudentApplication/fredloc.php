...
function getLocationStatus($t) {
	if ($t > 7 && $t <= 9) {
		 echo "<img src='etc/Salinan office.png'>";
	} 
	elseif ($t > 9 && $t <=11) {
		 echo "<img src='lantai3/3rd floor(1).png'>";
	}
	elseif ($t > 11 && $t <= 13) {
		 echo "<img src='etc/Salinan Lunch time.png'>";
	}
	elseif ($t > 13 && $t <= 15) {
		 echo "<img src='lantai4/4th floor(2).png'>";
	}
	elseif ($t > 15 && $t <= 17) {
		 echo "<img src='lantai4/4th floor(2).png'>";
	}
	else{
	echo "<img src='etc/Salinan House.png'>";
	}
}
?>
